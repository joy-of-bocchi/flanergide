...
Java_com_realityskin_ai_GGUFModel_llamaCppInit(JNIEnv* env, jobject, jstring modelPath) {
...
Java_com_realityskin_ai_GGUFModel_llamaCppGenerate(JNIEnv* env, jobject, jlong ctx, jstring prompt, jint maxTokens) {
...
add_library(realityskin SHARED llama_jni.cpp)

# Link llama.cpp
add_subdirectory(llama.cpp)
target_link_libraries(realityskin llama)
```
